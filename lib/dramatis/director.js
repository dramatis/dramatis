  ...
  Director.prototype = {
    ...
    unregister: function(actor) {
      ...
      for(var key in this.directory_index[id]) {
        // console.debug("unregister alpha",key);
    ...
    register: function(actor, id) {
      ...
      if (typeof id === "number") {
        ...
        // console.debug("register alpha",id);
    ...
    lookup: function(route, id) {
      // console.debug("lookup",route+"",id,route.is_local(this.reactor()));
      var name;
    ...
    lookup_actor: function(id) {
      // console.debug("lookup actor",id);
      if (typeof id === "number") {
        // console.debug("lookup actor #",this.actor_map[id]);
        return this.actor_map[id];
      } else {
        // console.debug("lookup actor alphs",id,typeof id,this.directory[id]);
        // window.backtrace();
