  ...
  XMPP = Channel.XMPP =
    new Channel.Class(function XMPP(url, good, bad){
      ...
      receiveIQ: function(iq) {
        ...
        case "result":
          // console.debug("okay stanza "+iq.getAttribute("id"));
      ...
      stanza: function(to, continuation) {
        ...
        // console.debug("set",id,!!continuation,continuation && !!continuation.exception);
